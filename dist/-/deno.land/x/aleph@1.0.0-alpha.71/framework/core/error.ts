import{VERSION as b}from"/-/deno.land/x/aleph@1.0.0-alpha.71/version.ts?v=181ca354fe3";export class FetchError extends Error{static async fromResponse(d){let e=d.status,a=await d.text(),c={};if(a.startsWith("{")&&a.endsWith("}"))try{let h=JSON.parse(a),{status:f,message:g,details:b,...i}=h;"number"==typeof f&&(e=f),"string"==typeof g&&(a=g),null===b||"object"!=typeof b||Array.isArray(b)||Object.assign(c,b),Object.assign(c,i);}catch(j){// ignore
