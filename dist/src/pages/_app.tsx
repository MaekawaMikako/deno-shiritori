...
import { jsx as r } from "/-/esm.sh/react@18.1.0/jsx-runtime?v=181c93324c9";
import { Link as f } from "/-/deno.land/x/aleph@1.0.0-alpha.71/framework/react/mod.ts?v=181c93324c9";
function i(t, c) {
  let { document: e } = globalThis;
  if (e) {
    let s = Array.from(e.head.children).find(
      (o) => o.getAttribute("data-module-id") === t && o.hasAttribute("ssr")
    );
    if (s) s.removeAttribute("ssr");
    else {
      let o = Array.from(e.head.children).filter(
          (a) => a.getAttribute("data-module-id") === t
        ),
        n = e.createElement("style");
      n.setAttribute("data-module-id", t),
        n.appendChild(e.createTextNode(c)),
        e.head.appendChild(n),
        o.length > 0 && o.forEach((a) => e.head.removeChild(a));
    }
  }
}
var x =
...
var d =
  "*{--color-brack:#333;--color-dark-gray:#454545;--color-gray:#6e6e6e;--color-light-gray:#c3c3c3;--color-white:#fff}header{width:100%;height:120px;font-family:AiShiroYukiguni_Free-Regular;position:fixed;top:0;left:0}header div{width:90%;height:100%;justify-content:flex-start;align-items:center;margin:0 auto;display:flex}header a{color:var(--color-dark-gray);cursor:pointer;font-size:16px;text-decoration:none;display:inline-flex}header a:hover{color:var(--color-brack)}";
i("./src/components/header/style.css", d);
function l() {
  return r("header", {
    children: r("div", {
      children: r("h1", {
